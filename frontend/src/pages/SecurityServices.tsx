      ...
      <div className="flex flex-col w-full">
        ...
        <div className="hero-container relative">
          ...
          <div className="full-size-background">
            <Image
              src="https://images.unsplash.com/photo-1502489597148-2d1bfec64f39?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80"
